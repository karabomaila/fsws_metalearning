...
def fast_adapt(
    sup_img, sup_msk, qry_img, qry_msk, learner, adaptation_steps, loss_name, device
):
    # Adapt the model.
...
def main(
    ...
    log_path = os.path.join(exp_group_dir, "train_metasgd.log")
    ...
    if "unet" in network_name:
        ...
        # Enveloping into MetaSGD wrapper.
