...
def meta_test(
    ...
    for sup in sup_list:
        ...
        adapt_opt = torch.optim.Adam(
            adapt_model.parameters(), lr=fast_lr, betas=(0, 0.999)
        )
...
def main(
    ...
    log_path = os.path.join(exp_group_dir, "test_reptile.log")
    ...
    for fold in folds:
        ...
        adapt_opt.load_state_dict(torch.load(adapt_opt_ckpt_path).state_dict())
